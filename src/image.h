...
void draw_detections_v3(image im, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output, int *left1, int *right1, int *top1, int *bot1, int step_i, int step_j, char *rect_txt);
